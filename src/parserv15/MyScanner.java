...
public class MyScanner {
    ...
    public enum tokenType {
        ReservedWord, SpecialSymbol, Identifier, Number, Undefined, Empty, LeftBracket, 
        RightBracket, Comment, LeftOvalBracket
    };

    private ArrayList<tokenType> tts = new ArrayList();
    ...
    public void setTokensArrayList(){
        int size = tts.size();
        for(int i = 0; i < size; i++){
                if(tts.get(i) == tokenType.Comment || tts.get(i) == tokenType.LeftBracket ||
                       tts.get(i) == tokenType.RightBracket){
                    tts.remove(i);
                    ss.remove(i);
                    size--;
                    i--;
...
//                currentState = state.START;
    ...
    public ArrayList getTokenTypeArrayList(){
        //setTokensArrayList();
        return tts;
    }
